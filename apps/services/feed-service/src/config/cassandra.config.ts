...
// and the AWS region as the "data center". Mirrors tweet-service/src/config/db.config.ts.
...
function buildClient(): cassandra.Client {
    ...
    return new cassandra.Client({
        ...
        // Keyspaces requires LOCAL_QUORUM (driver default LOCAL_ONE is rejected for writes;
        // reads accept it too). Set it as the default for all queries.
